...
class get_model(nn.Module):
    def __init__(self, num_points=1024, m=2, dropout=0.5, input_dim=3, extra_feat_dropout=0.0, useDensityFps=False):
        ...
        self.classificator = PointNetV2SemanticSegmentation(k=m, dropout=dropout, input_dim=input_dim, extra_feat_dropout=extra_feat_dropout,
                                                            single_scale_grouping=True, useDensityFps=useDensityFps)
...
class get_loss(nn.Module):
    def __init__(self, label_smoothing=0.0, gamma=1, dice=True, dice_eps=1, weights=None):
        ...
        self.loss_calculator = PointNetV2LossForSemanticSegmentation(ce_label_smoothing=label_smoothing, weights=weights)
